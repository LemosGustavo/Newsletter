     ...
     <article class="row entry format-standard">
         ...
         <div class="entry__header col-full">
             ...
             <ul class="entry__header-meta">
                 <?php $date = date("d/m/Y", strtotime($post[0]['title'])) ?>
         ...
         <div class="col-full entry__main">
             ...
             <p>
                 <img src="<?= base_url() ?>/assets/images/wheel-1000.jpg" srcset="<?= base_url() ?>/assets/images/wheel-2000.jpg 2000w, <?= base_url() ?>/assets/images/wheel-1000.jpg 1000w, <?= base_url() ?>/assets/images/wheel-500.jpg 500w" sizes="(max-width: 2000px) 100vw, 2000px" alt="">
             </p>
     ...
     <div class="s-content__entry-nav">
         <div class="row s-content__nav">
             <div class="col-six s-content__prev">
                 <a href="<?= base_url() . '/dashboard/post/' . $previouspost[0]->slug . '/' . $previouspost[0]->id ?>" rel="prev">
                     <span>Previous Post</span>
                     <?= $previouspost[0]->title ?>
                 </a>
             </div>
             <div class="col-six s-content__next">
                 <a href="<?= base_url() . '/dashboard/post/' . $previouspost[1]->slug . '/' . $previouspost[1]->id ?>" rel="next">
                     <span>Next Post</span>
                     <?= $previouspost[1]->title ?>
                 </a>
             </div>
         </div>
